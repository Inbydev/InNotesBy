            ...
            <header class="header__create__note">
                <nav class="note__navigation">
                    ...
                    <div class="close__and__send__container">
                        <button class="preview__button" id="btnPreview" type="button">
